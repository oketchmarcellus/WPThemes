...
class anviltech_repeater extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		if ( file_exists( get_template_directory() . '/inc/anviltech-service/icons.php' ) ) {
			$this->customizer_icon_container =  'inc/anviltech-service/icons';
		}
