...
//Add Partial Refresh for blogname,Blogdescription & Other Custom Theme Modes
	...
	$wp_customize->selective_refresh->add_partial( 'production_slider_content', array(
		'selector' => '#carousel-1',
		'setting' => array('production_slider_content'),
	) );
	$wp_customize->selective_refresh->add_partial( 'latestnews_category_posts', array(
		'selector' => '#carousel-2',
		'setting' => array('latestnews_category_posts'),
	) );
...
// Add Home Page Panel
	 $wp_customize->add_panel('homepage', array(
	 	'title' => __('Theme options', 'production'), 
	 	'description' => '',
	    'priority' => 140,));
//subtitle		
...
// Divider image Section
	$wp_customize->add_section('divider',array(
		'title' =>__('Divider image','production'),
	     'description' =>sprintf(__('Add a cover image to this section','production')),
	     'panel' => 'homepage',
	     'priority' =>81,));
// Home page Service Section
...
// Home page Latest Post Section
	$wp_customize->add_section('latest_news',array(
		'title' =>__('Latest news Content','production'),
	     ...
	     'panel' => 'homepage',
	     'priority' =>83,));
//Hide or show section1
	$wp_customize->add_setting(
    'production_options[section1_enabled]',
    array(
        'default' => true,
    ...
    'production_options[section1_enabled]',
    array(
        'label' => __('Enable section one','production'),
		'priority'   => 1,
        'section' => 'welcome',
        'type' => 'checkbox',
    )
...
//Hide or show section2
	$wp_customize->add_setting(
    'production_options[section2_enabled]',
    array(
        'default' => true,
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
    ...
    'production_options[section2_enabled]',
    array(
        'label' => __('Enable section two','production'),
		'priority'   => 1,
        'section' => 'divider',
        'type' => 'checkbox',
    )
	);
	$wp_customize->add_setting( 'divider_img_upload',array(
            'default' => esc_url(get_template_directory_uri()).'/assets/img/production-template-welcome-section.jpg',
            'transport' =>'postMessage',));
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize,'divider_img_upload', array(
            'label'       => __( 'divider image:', 'production' ),
            'section'     => 'divider',
            'settings'    => 'divider_img_upload',
            'description' => 'Upload your divider image here.'
    )));
//Hide or show section3
	$wp_customize->add_setting(
    'production_options[section3_enabled]',
    array(
        'default' => true,
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
    ...
    'production_options[section3_enabled]',
    array(
        'label' => __('Enable section three','production'),
		'priority'   => 1,
        'section' => 'releases',
        'type' => 'checkbox',
    )
...
//content				
	...
	$wp_customize->add_setting( 'releases_img_upload_one',array(
            'default' => esc_url(get_template_directory_uri()).'/assets/img/images_08.jpg',
            'transport' =>'postMessage',));
    ...
    $wp_customize->add_setting( 'releases_img_upload_two',array(
            'default' => esc_url(get_template_directory_uri()).'/assets/img/images_05.jpg',
            'transport' =>'postMessage',));
    ...
    $wp_customize->add_setting( 'releases_img_upload_three',array(
            'default' => esc_url(get_template_directory_uri()).'/assets/img/images_11.jpg',
            'transport' =>'postMessage',));
...
//Hide or show section4
	$wp_customize->add_setting(
    'production_options[section4_enabled]',
    array(
        'default' => true,
		'capability'     => 'edit_theme_options',
		'sanitize_callback' => 'sanitize_text_field',
    ...
    'production_options[section4_enabled]',
    array(
        'label' => __('Enable Latest News Section','production'),
		'priority'   => 1,
        'section' => 'latest_news',
        'type' => 'checkbox',
    )
...
if ( class_exists( 'Category_Dropdown_Custom_Control' ) ) {
	...
	$wp_customize->add_control( new Category_Dropdown_Custom_Control( $wp_customize, 'latestnews_category_posts', array(	 'label'      => esc_html__( 'Select Post Category for latest news content', 'production' ),
			'priority'   => 40,
			'section'    => 'latest_news',
...
function production_customize_releases_img_upload_one() {?>
	<img class="img-responsive" src="<?php echo get_theme_mod( 'releases_img_upload_one'); ?>">
<?php }
function production_customize_releases_img_upload_two() {?>
	<img class="img-responsive" src="<?php echo get_theme_mod( 'releases_img_upload_two'); ?>">
<?php }
function production_customize_releases_img_upload_three() {?>
	<img class="img-responsive" src="<?php echo get_theme_mod( 'releases_img_upload_three'); ?>">
<?php }
