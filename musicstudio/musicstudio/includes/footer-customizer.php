...
//footer bg-image	
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize,'footer_bg_img', array(
            'label'       => __( 'footer_bg_img:', 'production' ),
    ...
    $wp_customize->add_setting( 'sample_tinymce_editor', array(
            'sanitize_callback' => 'esc_textarea',
            'transport' =>'postMessage',
            'sanitize_callback' =>'wp_kses_post',
        ));

    $wp_customize->add_control( new Text_Editor_Custom_Control( $wp_customize,'sample_tinymce_editor', array(   'label'      => esc_html__( 'TinyMCE Control', 'production' ),
            'section'    => 'footer_section',
            'setting'    =>'footer_location_content',
            'description' => 'Add Location details here',
            'input_attrs' =>array('toolbar' =>'bold italic bullist numlist aligncenter alignright link' , )
            )));
        }
