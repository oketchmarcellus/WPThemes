<div class="bottom-wrapper" style="background-image: url('<?php echo get_template_directory_uri()?>/images/bottom-wrapper-bg.jpg');">
                        ...
                        <div class="uk-width-1-1">
                            <div class="uk-panel">
                                <div class="footer-logo">
                                    <a href="http://h-sportak.torbara.com/"><img src="<?php echo get_template_directory_uri()?>/<?php echo get_template_directory_uri()?>/images/footer-logo-img.png" alt=""><span>Sport</span>.ak</a>
                                </div>
                                                    ...
                                                    <div class="wrapper">
                                                        <div class="logo">
                                                            <a href="match-single.html">
                                                                <img src="<?php echo get_template_directory_uri()?>/images/team-ava.png" class="img-polaroid" alt="England VS Amsterdam (2015-11-14)" title="England VS Amsterdam (2015-11-14)">
                                                            </a>
                                                        </div>
                                                        <div class="team-name">
                                                            England </div>
                                                        ...
                                                        <div class="logo">
                                                            <a href="match-single.html">
                                                                <img src="<?php echo get_template_directory_uri()?>/images/team-ava1.png" class="img-polaroid" alt="England VS Amsterdam (2015-11-14)" title="England VS Amsterdam (2015-11-14)">
                                                            </a>
                                                        </div>
                                            ...
                                            <li class="" aria-hidden="true">
                                                <div class="match-list-item alt foot">
                                                    <div class="wrapper">
                                                        <div class="logo">
                                                            <a href="match-single.html">
                                                                <img src="<?php echo get_template_directory_uri()?>/images/team-ava2.png" class="img-polaroid" alt="Cambridgehire VS china (2015-11-29)" title="Cambridgehire VS china (2015-11-29)">
                                                            </a>
                                                        </div>
                                                        <div class="team-name">
                                                            Cambridgehire </div>
                                                        ...
                                                        <div class="logo">
                                                            <a href="match-single.html">
                                                                <img src="<?php echo get_template_directory_uri()?>/images/team-ava3.png" class="img-polaroid" alt="Cambridgehire VS china (2015-11-29)" title="Cambridgehire VS china (2015-11-29)">
                                                            </a>
                                                        </div>
                                                        <a class="read-more" href="match-single.html">Read More</a>
                                                    </div>
                                            ...
                                            <li class="" aria-hidden="true">
                                                <div class="match-list-item alt foot">
                                                    <div class="wrapper">
                                                        <div class="logo">
                                                            <a href="match-single.html">
                                                                <img src="<?php echo get_template_directory_uri()?>/images/team-ava4.png" class="img-polaroid" alt="Cambridgehire VS china (2015-11-20)" title="Cambridgehire VS china (2015-11-20)">
                                                            </a>
                                                        </div>
                                                        <div class="team-name">
                                                            Cambridgehire </div>
                                                        ...
                                                        <div class="logo">
                                                            <a href="match-single.html">
                                                                <img src="<?php echo get_template_directory_uri()?>/images/team-ava5.png" class="img-polaroid" alt="Cambridgehire VS china (2015-11-20)" title="Cambridgehire VS china (2015-11-20)">
                                                            </a>
                                                        </div>
                                                        <a class="read-more" href="match-single.html">Read More</a>
                                                    </div>
                                            ...
                                            <li class="" aria-hidden="true">
                                                <div class="match-list-item alt foot">
                                                    <div class="wrapper">
                                                        <div class="logo">
                                                            <a href="match-single.html">
                                                                <img src="<?php echo get_template_directory_uri()?>/images/team-ava4.png" class="img-polaroid" alt="King VS china (2015-11-20)" title="King VS china (2015-11-20)">
                                                            </a>
                                                        </div>
                                                        <div class="team-name">
                                                            King </div>
                                                        ...
                                                        <div class="logo">
                                                            <a href="match-single.html">
                                                                <img src="<?php echo get_template_directory_uri()?>/images/team-ava5.png" class="img-polaroid" alt="King VS china (2015-11-20)" title="King VS china (2015-11-20)">
                                                            </a>
                                                        </div>
                                                        <a class="read-more" href="match-single.html">Read More</a>
                                                    </div>
