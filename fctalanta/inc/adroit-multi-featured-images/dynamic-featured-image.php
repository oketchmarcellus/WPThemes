...
class dynamic_multi_featured_image {
    ...
    public function __construct() {
        ...
        // add action links.
        add_filter( 'plugin_action_links_' . get_template_directory_uri(), array( $this, 'dfi_action_links' ) );
    ...
    public function enqueue_admin_scripts() {
        // enqueue styles.
        wp_enqueue_style( 'style-dfi', get_template_directory_uri() .'/css/style-dfi.css', array(), self::VERSION );

        // register script.
        wp_register_script( 'scripts-dfi', get_template_directory_uri() .'/js/script-dfi.js', array( 'jquery' ), self::VERSION );
