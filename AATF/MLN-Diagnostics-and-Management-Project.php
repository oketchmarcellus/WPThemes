<?php
/*
*Template Name: AATF MLN Diagonistics and Management Projects Template
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-9 col-sm-8 col-12" style="padding-right:30px;">
							<div class="section-title" style="margin-bottom:20px;">
							 ...
							 <p style="text-align:justify;">Maize Lethal Necrosis Disease (MLND) is a key regional challenge that continues to bring havoc
to farmers' maize grain harvest and threatens food security in the eastern African region. It
causes yield loses of up to 100% and has been registered as a threat to food security in the
region. MLND is caused by the co-infection of Maize Chlorotic Mottle Virus (MCMV) and any of
the Potyviruses infecting cereals, especially Sugarcane Mosaic Virus (SCMV). The disease was
reported in Kenya in September 2011, and later in Tanzania, Uganda, Rwanda, DR Congo, South
Sudan and Ethiopia.</p>
<p style="text-align:justify;">
MLN pathogens can be transmitted by insect vectors and also through contaminated seed.
Some developed countries have managed the disease through strategies that include
combining tolerant varieties, crop rotation, and having maize free seasons to reduce the insect
vector pressure that transmits the disease. However, in eastern Africa, the epidemic is
aggravated by little access to MLN tolerant maize varieties by farmers and year-round
cultivation of maize, allowing transmission via insect vectors, among others.</p>
<p style="text-align:justify;">
AATF and AGRA are co-leading efforts towards supporting the commercial seed sector in
Kenya, Uganda, Tanzania, Rwanda and Ethiopia in production of MCMV-free maize seed, as
well as promoting the use of certified seeds by farmers in respective countries.</p>
<p style="text-align:justify;">
The Project is coordinated by the International Maize and Wheat Improvement Centre
(CIMMYT), under the USAID-funded MLN Diagnostics and Management Project.
</p>
                            ...
                            <div class="row no-gutters">
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
									...
									<div class="row counter-pg">
										...
										<div class="col-md-12 col-sm-12 col-xs-12"><p style="color:#333333;">Control the spread of Maize Chlorotic Mottle Virus (MCMV) in MLN-endemic countries of Eastern Africa while preventing its spread to MCMV from entering non-endemic countries especially in Southern Africa.</p>
										</div>
									</div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
									...
									<div class="row counter-pg">
										...
										<div class="col-md-12 col-sm-12 col-xs-12"><p style="color:#333333;">Support the commercial seed sector in MLN-endemic countries in producing MCMV-free commercial seed and Promote the use of clean certified hybrid seed by farmers.</p>
										</div>
									</div>
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                                    <div class="row counter-pg">
										...
										<div class="col-md-12 col-sm-12 col-xs-12"><p style="color:#333333;">“If the industry does not get systematic and standardized scientific steps and operating procedures, decisions on control and management of MLN will be subjective.” – Erick Tegei, Quality Assurance Manager, Kenya Seed Company </p>
										</div>
									</div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-4 col-md-6 text-center">
                            <div class="row justify-content-center pg">
								...
								<div class="pg-text">
									<h4> FARMERS</h4>
									<p>Farmers can now control loss on harvest through use of and access to clean, certified MLN tolerant maize varieties. </p> 
								</div>
							</div>
                        </div>
                        <!--// Single Price box -->
                        ...
                        <div class="col-lg-4 col-md-6 text-center">
                            <div class="row justify-content-center pg">
								...
								<div class="pg-text">
									<h4>  BUSINESSES</h4>
							 		<p>Commercial farmers can now obtain maximum maize productivity by reducing/mitigating MLN disease incidences in their farms through supply chains of seed companies. </p>
								</div>
							</div>
                        </div>
                        <!--// Single Price box -->
                        ...
                        <div class="col-lg-4 col-md-6 text-center">
                            <div class="row justify-content-center pg">
								...
								<div class="pg-text">
									<h4> SOCIETY </h4>
							 		<p>Increased levels of maize production that ensures the region is relatively food secure. </p>
								</div>
							</div>
									...
									<div class="row counter-pg">
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											...
											<div class="text-center" style="border:none;">
												<h3><span class="counter-active">78</span>%</h3>  
											</div>
										</div> 
									</div>
									<div class="row counter-pg">
										<div class="col-md-12 col-sm-12 col-xs-12" style="padding:0; margin:0;">
											<p>Number of seed companies
engaged in MLN management and
MCMV free seed production </p>
										</div>
									</div>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 text-center">
									...
									<div class="row counter-pg">
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											...
											<div class="text-center" style="border:none;">
												<h3><span class="counter-active">1137</span>+</h3>  
											</div>
										</div> 
									</div>
									<div class="row counter-pg">
										<div class="col-md-12 col-sm-12 col-xs-12" style="padding:0; margin:0;">
											<p>Number of maize seed out-growers
engaged in MCMV-free seed
production training</p>
										</div>
									</div>
								...
								<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 text-center">
									...
									<div class="row counter-pg">
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											...
											<div class="text-center" style="border:none;">
												<h3><span class="counter-active">1500</span>+</h3>  
											</div>
										</div> 
									</div>
									<div class="row counter-pg">
										<div class="col-md-12 col-sm-12 col-xs-12" style="padding:0; margin:0;">
											<p>Number of farmers engaged
through field days & training on
MLN management awareness</p>
										</div>
									</div>
								...
								<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12 text-center">
									...
									<div class="row counter-pg">
										...
										<div class="col-md-12 col-sm-12 col-xs-12">
											...
											<div class="text-center" style="border:none;">
												<h3><span class="counter-active">100</span>% </h3>  
											</div>
										</div> 
									</div>
									<div class="row counter-pg">
										<div class="col-md-12 col-sm-12 col-xs-12" style="padding:0; margin:0;">
											<p>Level of uptake and use of
MLN Management SOPs
by seed companies engaged</p>
										</div>
									</div>
				...
				<div class="container">
					<div class="row text-center">
                        <div class="col-lg-12 col-md-12  col-12">
							<a href="https://www.aatf-africa.org"><img src="<?php echo get_template_directory_uri(); ?>/images/projects/MLN_files/AATF-project-logos-MLN-AATF.jpg" width="200" style="margin-right:5px;" ></a>
							<a href="https://www.usaid.gov/"><img src="<?php echo get_template_directory_uri(); ?>/images/projects/MLN_files/AATF-project-logos-MLN-USAID.jpg" width="200" style="margin-right:10px;" > </a>
							<img src="<?php echo get_template_directory_uri(); ?>/images/projects/MLN_files/AATF-project-logos-MLN-CIMMYT.jpg" width="200" style="margin-right:10px;" > 
							<a href="https://agra.org/"><img src="<?php echo get_template_directory_uri(); ?>/images/projects/MLN_files/AATF-project-logos-MLN-AGRA.jpg" width="200" style="margin-right:5px;" > </a>
					 ...
					 <div class="row justify-content-center service-slider-active cr-slider-dots-1"> 
						...
						<div class="col-lg-12 col-md-12">
							<article class="blog blog2"> 
								<div class="blog-content"> 
									<h6 class="header-h5"> Maize lethal necrosis (MLN): Efforts toward containing the spread and impact of a devastating transboundary disease in sub-Saharan Africa</h6>
									<p></p>
						...
						<div class="col-lg-12 col-md-12">
							<article class="blog blog2"> 
								<div class="blog-content"> 
									<h6 class="header-h5"> SOPS – MLN disease portal </h6>
									<p></p>
									<a href="#" class="resource-btn"> Download Resource file </a>
								</div>
                ...
                <div class="container">  
					<div class="row" style="margin-bottom:20px;">
						...
						<h4 class="p"> PROJECT MANAGEMENT </h4>
							 <div class="row" style="margin-bottom:20px;">
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"> <img src="<?php echo get_template_directory_uri(); ?>/images/projects/MLN_files/SamAngwenyi.jpg" style="border-radius:50%;"> </div>
								<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8"> <h5 class="header-h5">Samuel Angwenyi</h5>
									<p class="header-p">Project Coordinator</p>
									<h5 class="header-h5-2"> S. Angwenyi@aatf-africa.org</h5>
								</div>
							</div>
						...
						<div class="col-lg-6 col-md-6">
							...
							<h4 class="p"> PROJECT INVESTORS </h4>
							 <div class="row" style="margin-bottom:20px;"> 
							 	<div class="col-lg-12 col-md-12"> <a href="https://www.usaid.gov/"><img src="<?php echo get_template_directory_uri(); ?>/images/projects/COWPEA/usaid-logo.jpg" width="260" ></a> </div>
								<div class="col-lg-12 col-md-12"><p>The United States Agency for International Development
(USAID), one of the original funders of AATF, supports the
Nitrogen-Use Efficient, Water-Use Efficient, Salt-Tolerant
Rice Project; Pod-Borer Resistant Cowpea Project; and
the Water Efficient Maize for Africa project. USAID
supports the MLN Diagnostics and Management Project
through CIMMYT. USAID also supported the Striga
Control in Maize project as part of the US government’s
Feed the Future initiative.</p>
								</div>
							</div>
						</div>
					</div>
