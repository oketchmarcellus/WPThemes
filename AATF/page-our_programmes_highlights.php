<?php
/*
*Template Name: AATF Programmes Higlights 
...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post();
        $args1 = array('post_type' => 'Aatf_programmes', 'posts_per_page' => 100, 'order' => 'ASC',);
        $count = 0;
        $programme_items= new WP_Query( $args1 );?>
    <!-- Main wrapper -->
			...
			<section class="services-area bg-white" style="padding:30px;">
                <div class="container">
					...
					<div class="row services-grid">
                         <?php while ( $programme_items->have_posts() ) :  $programme_items->the_post();?>
                        <!-- Signle Service -->
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="service service-style-4">
                                <div class="service-image">
                                    <a href="Farm-Productivity.php"><img src="<?php echo wp_get_attachment_url(get_post_thumbnail_id()); ?>" alt="Service Thumb"></a>
                                </div>
                                <div class="service-content-2">
                                    <a href="Farm-Productivity.php"><h4><?php the_title();?></h4></a>
                                    <p>Integrated innovations and know-how application that will improve agricultural productivity of African staple and cash crops</p> <br><br>
									 <a href="Farm-Productivity.php" class="cr-btn"> <span>Read More</span> </a> 
                                </div>
                            </div>
                        </div>
                        <!--// Signle Service -->
