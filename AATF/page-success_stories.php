<?php
/*
*Template Name: AATF Success Stories Template
...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post();
    $args = array('post_type' => 'Success_stories', 'posts_per_page' => 18, 'orderby'=>'date',);
        $count = 0;
        $aatf_stories= new WP_Query( $args );?>
    <!-- Main wrapper -->
    <div class="wrapper" id="wrapper">
        ...
        <main class="page-content">  
			...
			<section class="services-area  bg-white" style="padding:30px;">
                <div class="container"> 
					<div class="row">
                    <?php while ( $aatf_stories->have_posts() ) :  $aatf_stories->the_post();?>

                        <!-- Signle Service -->
                        <div class="col-lg-4 col-md-4 col-12">
                            <div class="service service-style-4 ">
                                <div class="service-image">
                                    <a href="<?php echo esc_url(get_permalink());?>"><img src="<?php echo wp_get_attachment_url(get_post_thumbnail_id()); ?>" alt="Service Thumb"></a>
                                </div>
