...
class agridrive_stats_Repeater extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		if ( file_exists( get_template_directory() . '/inc/agridrive-stats/icons.php' ) ) {
			$this->customizer_icon_container =  'inc/agridrive-stats/icons';
		}
