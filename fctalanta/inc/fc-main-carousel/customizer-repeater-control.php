...
class fctalanta_Mainslider_Repeater extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'agridrive_customizer-repeater-admin-stylesheet', get_template_directory_uri() . '/css/admin-style.css', array(), 999 );
		wp_enqueue_script( 'agridrive_customizer-repeater-script', get_template_directory_uri() . '/js/customizer_repeater.js', array('jquery', 'jquery-ui-draggable'), 999, true  );
	}
