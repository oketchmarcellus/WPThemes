...
class safari_services_repeater extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		if ( file_exists( get_template_directory() . '/inc/safari-services/icons.php' ) ) {
			$this->customizer_icon_container =  'inc/safari-services/icons';
		}
