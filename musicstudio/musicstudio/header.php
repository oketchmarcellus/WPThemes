...
<body><?php $slide_options = get_theme_mod('production_slider_content');
        $current_options = wp_parse_args(  get_option( 'production_options', array() ), $production_options );?>
    <header class="mast-head" style="background-image: url('<?php ($current_options["home_slider_enabled"] == false) ?header_image():""; ?>');">
