...
if ( ! class_exists( 'WP_Customize_Control' ) ) return NULL;
	...
	$wp_customize->add_section(
        ...
        array(
            'title' => __('Manage Slider','production'),
            'description' =>sprintf(__('Options for homepage Slider','production')),
            'panel'  => 'homepage',
            'priority' =>79,
    ));
    ...
    'production_options[home_slider_enabled]',
    array(
        'label' => __('Enable home slider','production'),
		'priority'   => 1,
	...
	if ( class_exists( 'Production_Repeater' ) ) {
			...
			$wp_customize->add_control( new Production_Repeater( $wp_customize, 'production_slider_content', array(
				'label'                             => esc_html__( 'Slider Content', 'production' ),
				'priority'   => 2,
				'section'                           => 'slider_section_settings',
				'add_field_label'                   => esc_html__( 'Add new slide', 'production' ),
				'item_name'                         => esc_html__( 'Slide', 'production' ),
    ...
    array(
        'type' => 'select',
        'label' => __('Slideshow speed','production'),
        'section' => 'slider_section_settings',
